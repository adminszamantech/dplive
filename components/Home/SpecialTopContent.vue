<template>
    <div class="specialContent py-1 md:py-3">
            ...
            <div class="col-span-12 md:col-span-7">
                <div class="grid grid-cols-12 gap-4">
                    <div class="col-span-12 md:col-span-7 group">
                        ...
                        <NuxtLink
                            :to="getPostUrl(specialTopContents[0]?.category?.cat_slug, specialTopContents[0]?.subcategory?.subcat_slug, specialTopContents[0]?.content_type, specialTopContents[0]?.content_id)"
                            ...
                            <span class="text-sm text-black">
                                {{ specialTopContents[0]?.category?.cat_name_bn }} | {{
                    ...
                    <div class="col-span-12 md:col-span-5">
                        <div class="flex flex-col gap-2">
                            <!-- ========== Loop Item  =========== -->
                            <NuxtLink
                                :to="getPostUrl(topcontent?.category?.cat_slug, topcontent?.subcategory?.subcat_slug, topcontent?.content_type, topcontent?.content_id)"
        ...
        topcontent?.content_heading }} </h4>
                                    <span class="text-sm text-black">{{ topcontent?.category?.cat_name_bn }} | {{
